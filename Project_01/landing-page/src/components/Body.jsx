  ...
  return (
    <div className="px-4 md:px-8">
      <div className="flex items-center justify-center">
        <img src="./assets/Blue-Shape.svg" alt="" className="-rotate-[45deg] h-80"/>
        <img src="./assets/Pink-Shape.svg" alt="" className="absolute h-80 -rotate-[30deg]"/>
        <img src="./assets/Purple-Shape.svg" alt="" className="absolute h-80 -rotate-[15deg]"/>
        <img src="./assets/Hero-Model.png" alt="" srcset="" className="absolute h-80"/>
      </div>
