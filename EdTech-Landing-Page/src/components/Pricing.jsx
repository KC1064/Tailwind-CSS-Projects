...
const Pricing = () => {
  return (
    <div className="flex flex-col text-center">
      ...
      <div className="flex justify-center md:px-6 lg:w-[90%] lg:justify-center lg:ml-16">
        <div className="text-left border-solid border-2 border-gray-300 rounded-2xl md:w-[90%] lg:pl-10">
          <div className="lg:flex lg:justify-center lg:align-middle">
            <div className="lg:w-[50%]">
              <h2 className="pt-10 text-xl font-bold font-spline px-9 lg:text-3xl">
                Premium Elite Subscription
              </h2>
              <p className="pt-3 font-spline px-9 text-lg">
                Join founders, freelancers, designers, FAANG engineers, indie
                hackers, and more in our 24/7 WhatsApp Group for less than a cup
                of coffee.
              </p>
              <p className="flex items-center gap-2 font-bold text-green-500 px-9 pt-10 lg:text-xl">
                What's included{" "}
                <div className="flex-auto h-[2px] bg-gray-200 mt-1"></div>
              </p>
              <div className="flex flex-col px-9 md:flex-row md:flex-wrap md:gap-x-16 lg:text-xl">
                <h3 className="flex items-center gap-2 mt-4">
                  <img src="./images/icon-check.svg" alt="" />
                  Expert Mentors
                </h3>
                <h3 className="flex items-center gap-2 mt-4 md:ml-[90px] lg:text-xl lg:ml-[113px]">
                  <img src="./images/icon-check.svg" alt="" />
                  Exclusive Courses
                </h3>
                <h3 className="flex items-center gap-2 mt-4 lg:text-xl">
                  <img src="./images/icon-check.svg" alt="" />
            ...
            <div className="flex lg:w-[49%] lg:pl-10 lg:justify-end lg:mb-2">
