...
const Header = () => {
  return (
    <div className="w-full md:flex md:py-4 md:px-5 md:items-center md:justify-center lg:px-8">
      <div className="flex justify-between w-[100%] md:h-auto md:items-center">
        ...
        <button className="text-sm border-none bg-black text-white rounded-full font-semibold px-3 font-spline w-[139px] hover:bg-primary lg:h-8">
          Join Community
        </button>
      </div>
    </div>
