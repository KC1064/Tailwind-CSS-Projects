  ...
  return (
    <div className="mt-16 flex flex-col gap-10 md:gap-12">
      <div className="flex flex-col gap-6">
        <h1 className="text-6xl font-spline font-bold text-center leading-none text-primary pt-3 md:text-8xl">
          ATTEND <span>LIVE</span>
          <span className="text-black"> CLASSES EVERY WEEK</span>
        </h1>
        <p className="text-center text-[16px] font-semibold font-poppins md:text-[20px] md:px-20 md:py-6">
